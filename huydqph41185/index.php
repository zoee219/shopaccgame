    ...
    <div class="my-6">
        <div class="w-full max-w-6xl mx-auto relative block2">
            <div class="flex md:flex-row-reverse flex-wrap">
                    ...
                    <iframe width="100%" height="350" src="https://www.youtube.com/embed/1a5YAeVGzWQ?si=aq5GXPvuY9SidTe1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
